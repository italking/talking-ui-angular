...
import {TkAlertCenterService} from '../../../tkui/alert/tk.alert.center.service';
import {AlertType} from '../../../tkui/alert/tk.alert-type';
import {Alert} from '../../../tkui/alert/tk.alert';

@Component({
  selector: 'app-tui-alert-info',
  template: `
<div class="alert-container" [style.left]="getLeft()" [style.right]="getRight()"></div>
<div class="container">
  <br><br>
  <div class="row">
...
export class TkAlertInfoComponent implements OnInit {
  alert: Alert = new Alert (
    AlertType.SUCCESS,
    TkAlertInfoComponent.createTestText(),
    TkAlertInfoComponent.createTestTextStrong(),
    5000
  );
